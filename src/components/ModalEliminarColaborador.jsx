...
const ModalEliminarColaborador = () => {
    ...
    return (
        //se motrara dependiendo del valor de modalEliminarTarea, que se modifica con handleModalEliminarTarea
                    ...
                    >
                            ...
                            <div className="sm:flex sm:items-start">
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <div className='mt-2'>
                                        <p className='text-sm text-gray-500'>Un colaborador eliminado, no podrá acceder al proyecto</p>
